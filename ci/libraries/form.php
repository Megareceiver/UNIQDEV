...
class form extends ci {
	...
	static function formInput($template=null, $params=null){
		...
		switch ($type){
			...
			case 'currency':
			case 'CURRENCY':
                $showHomeCurrency = isset($input_field["homecurr"]) ? $input_field["homecurr"] : true;
				return $ci->finput->currency(null,$name, $value,$attributes,$disabled, $showHomeCurrency); break;
				break;
			case 'number':
