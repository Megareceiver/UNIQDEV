...
class PurchasesTranReceive
{
    ...
    function form ()
    {
        ...
        box_footer_start();
        submit_icon('Update', _("Update"), "save");
        submit_icon('ProcessGoodsReceived', _("Process Receive Items"), "check-square-o",_("Clear all GL entry fields") );
...
//         date_row(_("Date Items Received"), 'DefaultReceivedDate', '', true, 0, 0, 0, '', true);
    ...
    private function po_receive_items()
    {
        ...
        start_table(TABLESTYLE, "colspan=7");
