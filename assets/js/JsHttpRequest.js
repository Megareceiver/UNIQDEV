...
function JsHttpRequest() {
    ...
    t.ajax_ready = function(){
    	//msicSelect();
    	if (typeof import_items_action == 'function') {
    		//import_items_action();
	}

    	$.map(ajax_fun, function(value, key) {
    		fn = ajax_fun[key];
//    		console.log(key);
...
//    	alert('end ajax_ready'); return false;
    };
    ...
    t._hash2query = function(content, prefix, queryText, queryElem) {
        ...
        if((''+typeof(content)).toLowerCase() == 'object') {
            ...
            for (var k in content) {
                ...
                var curPrefix = prefix? prefix + '[' + this.escape(k) + ']' : k;
    ...
    t._changeReadyState = function(s, reset) { with (this) {
        ...
        readyState = s;
        if (typeof onreadystatechange !=='undefined' ) {
...
JsHttpRequest.query = function(url, content, onready, nocache) {
    ...
    req.onreadystatechange = function() {
        if (req.readyState == 4 && typeof req.responseJS !== 'undefined' ) {
