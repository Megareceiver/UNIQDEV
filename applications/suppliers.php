...
class suppliers_app extends application
{
	function suppliers_app()
	{
		...
		$this->add_module(_("Dashboard"),'fa fa-home', "/purchases/dashboard");
		...
		$this->add_lapp_function(1, _("Purchase Orders"), "purchasing/inquiry/po_search_completed.php?", 'SA_SUPPTRANSVIEW', MENU_INQUIRY,'send-o');
		$this->add_lapp_function(1, _("Direct &GRN"), "purchasing/inquiry/supplier_inquiry.php?filtertype=6", 'SA_GRN', MENU_TRANSACTION,'ship');
// 		$this->add_lapp_function(0, _("Direct &Invoice"),"purchasing/po_entry_items.php?NewInvoice=Yes", 'SA_SUPPLIERINVOICE', MENU_TRANSACTION);
		$this->add_lapp_function(1, _("Direct &Invoice"), "purchasing/inquiry/supplier_inquiry.php?filtertype=1", 'SA_SUPPLIERINVOICE', MENU_TRANSACTION ,'file-pdf-o');

		$this->add_rapp_function(1, _("Supplier &Invoices"),"purchasing/inquiry/supplier_inquiry.php?filtertype=2", 'SA_SUPPLIERINVOICE', MENU_TRANSACTION,'file-pdf-o');
...
// 		$this->add_rapp_function(0, "","");
		...
		if( config_ci('kastam')){
		    $this->add_lapp_function(1, _("Bad Debt Processing"), "admin/bad_deb.php?type=supplier", 'SA_SUPPLIERALLOC', MENU_TRANSACTION,'trash-o');
		}
...
// 			"reporting/reports_main.php?Class=1&REP_ID=202", 'SA_CUSTOMER', MENU_ENTRY);
		...
		$this->add_lapp_function(5, _("&Suppliers Maintenance"),"purchasing/manage/suppliers.php?", 'SA_SUPPLIER', MENU_ENTRY,'male');
